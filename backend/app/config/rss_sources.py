...
CHINESE_NEWS_SOURCES = [
    ...
    {
        "url": "https://www.bishijie.com/feed",
        "name": "币世界",
        "category": "news",
        "source_type": "rss",
        "priority": 4,
    ...
    {
        "url": "https://www.chainnode.com/rss",
        "name": "链节点",
        "category": "news",
        "source_type": "rss",
        "priority": 3,
...
DEFI_NFT_SOURCES = [
    {
        "url": "https://defiprime.com/rss.xml",
        "name": "DeFi Prime",
        "category": "defi",
        "source_type": "rss",
        "priority": 3,
...
# 合并所有RSS源
ALL_RSS_SOURCES = EXCHANGE_RSS_SOURCES + CRYPTO_NEWS_SOURCES + CHINESE_NEWS_SOURCES + DEFI_NFT_SOURCES
...
# 重要性评分权重
IMPORTANCE_WEIGHTS = {
    "exchange_announcement": 3,  # 交易所公告基础分数
    "listing_news": 4,          # 上币新闻
    "security_alert": 5,        # 安全警报
    "regulatory_news": 4,       # 监管新闻
    "partnership": 2,           # 合作伙伴关系
    "technical_update": 2,      # 技术更新
    "market_analysis": 1        # 市场分析
}
